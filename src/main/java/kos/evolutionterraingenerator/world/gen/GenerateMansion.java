...
import kos.evolutionterraingenerator.world.EvoChunkGenerator;
...
public class GenerateMansion extends MapGenStructure
{
    ...
    private final EvoChunkGenerator provider;
    private final BiomeProviderEvo biomeProvider;

    public GenerateMansion(EvoChunkGenerator providerIn, BiomeProviderEvo providerBiome)
    {
        this.provider = providerIn;
        this.biomeProvider = providerBiome;
    }
    ...
    {
        return new GenerateMansion.Start(this.world, this.provider, this.rand, chunkX, chunkZ);
    }
    ...
    public static class Start extends StructureStart
        {
            ...
            public Start(World p_i47235_1_, EvoChunkGenerator p_i47235_2_, Random p_i47235_3_, int p_i47235_4_, int p_i47235_5_)
            {
                super(p_i47235_4_, p_i47235_5_);
                this.create(p_i47235_1_, p_i47235_2_, p_i47235_3_, p_i47235_4_, p_i47235_5_);
            }

            private void create(World p_191092_1_, EvoChunkGenerator p_191092_2_, Random p_191092_3_, int p_191092_4_, int p_191092_5_)
            {
