...
public class DefaultBiomeContainers 
{
	...
	public static void createContainers() {
		...
		if (bygEnabled) {
			...
			containers.add(new BiomeContainer(BiomeList.BYG_ALLIUM_FIELDS, 0.5, 0.25, 0.841).setWeirdnessRange(0.002));
			...
			containers.add(new BiomeContainer(BiomeList.BYG_CHERRY_BLOSSOM_FOREST, 0.5, 0.5, 0.675));
		...
		if (bygEnabled) {
			...
			containers.add(new BiomeContainer(BiomeList.BYG_CYPRESS_SWAMPLANDS, 0.785, 0.5, 0.185).setCategory(Category.SWAMP));
			containers.add(new BiomeContainer(BiomeList.BYG_MANGROVE_MARSHES, 0.75, 0.95, 0.145));
